...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", default=10, type=int) # 약 4G 모델
    parser.add_argument("--model", default="facebook/opt-iml-max-30b")
    parser.add_argument("--log_dir", default="./runs/opt-iml-max-30b_gyafc")
    ...
    parser.add_argument("--valid_data_path", default="./GYAFC_Corpus/GYAFC_Corpus/concated_tune.json")
    ...
    parser.add_argument("--checkpoint_path", default="./lora_models/opt_iml_max_30b/r8/gyafc/opt-iml-30b_gyafc_lora")
    ...
    for epoch in range(opt.num_epochs):
        ...
        for i, (batch, batch_label) in enumerate(tqdm(zip(train_dataloader, train_label_dataloader))):
            ...
            if current_step % 500 == 0 and current_step != 0:
                ...
                torch.save(lora.lora_state_dict(model), opt.checkpoint_path+f"_{current_step}_{round(total_valid_loss/len(valid_label_dataloader), 2)}.pt")
