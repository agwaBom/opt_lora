...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", default="./lora_models/opt_iml_max_1_3b/r8/gyafc/opt-iml-1_3b_gyafc_em_lora")
    ...
    if opt.train_data_path == "gsm8k":
        ...
        if "GYAFC" in opt.train_data_path:
            rc_a = "informal"
            rc_b = "formal"
        elif "wmt" in opt.train_data_path:
            rc_a = "du"
            rc_b = "en"
