...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default="./dataset/test.json")
    ...
    parser.add_argument("--output_dir", default="./lora_output/opt-iml-1_3b/r8/wmt22/")
    parser.add_argument("--lora_checkpoint_path", default="./lora_models/opt_iml_max_1_3b/r8/wmt22/opt-iml-1_3b_wmt22_lora_900_1.8.pt")
